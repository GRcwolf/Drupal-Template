 ...
 * its location.
 */
$settings['config_sync_directory'] =  DRUPAL_ROOT . '/../private/config/base';
 ...
 * @endcode
 */
$settings['hash_salt'] = 'uiq1RNU8eAWLyB6DD1SeqgiCWSIG7jcyHkpWjWU9/6ArLF/WROUZbbUPJg7Rm7PY';
...
$settings['php_storage']['twig']['directory'] = DRUPAL_ROOT . '/../private/cache/php';

$config['config_split.config_split.dev']['status'] = DEBUG;
$config['config_split.config_split.prod']['status'] = !DEBUG;
